...
2. [Project Success Criteria](#project-success-criteria)
...
- [x] Replayability (New or similar content)
- [x] Good system performance (Consistent frame rate, optimised code and sprites)
- [x] Complete game (Player can experience all essential parts of [My Solution](0.%20Proposed%20Solution.md))
- [x] Engaging game content (Visually appealing sprite design, easter eggs, unlockable content)
- [x] Modular code reflects OOP paradigm (Classes, Objects, Attributes, Methods, etc.)